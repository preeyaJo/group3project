  ...
  return (
    <div className="information">
      ...
      <div className="contact Show-score QuizItem rounded text-center text-secondary d-flex flex-column justify-content-center align-items-center">
        <p>{data.info3}</p>
        <FontAwesomeIcon icon={faPhone} /> climatechange@change.se
        <FontAwesomeIcon icon={faEnvelope} /> 010-10 100 10
      </div>
      <Link to="/">
        <Button className="knapp m-2">Läs mer om global uppvärmning</Button>
      </Link>
    </div>
  );
}
